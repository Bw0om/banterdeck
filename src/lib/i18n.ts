...
export const UI = {
  ...
  no: {
    locale: 'nb_NO',
    htmlLang: 'no',
    tagline: 'Frekke replikker, ord, uttrykk og drikkeleker – klare til bruk.',
    ...
    heroSub: (l: number, w: number, g: number) =>
      w > 0
        ? `${l} frekke replikker, ${w} ord og uttrykk og ${g} drikkeleker – sortert etter situasjonen du står i.`
